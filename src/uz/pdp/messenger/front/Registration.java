...
public class Registration {
    ...
    static {
        ...
        try {
            UserDTO userDTO1 = instance.signUp(new SignUpDTO("Azizbek", "Reimov", "@reimoffazizbek", "+998904217300", "1234567a"));
            UserDTO userDTO2 = instance.signUp(new SignUpDTO("Maqsud", null, "@maqsud", "+998904517002", "1234567m"));
            UserDTO userDTO3 = instance.signUp(new SignUpDTO("Sardorbek", null, "@sardor", "+998904201515", "1234567s"));
